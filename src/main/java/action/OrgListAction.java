...
public class OrgListAction extends ActionSupport implements RequestAware, SessionAware, ModelDriven<OrgListEntity>, Preparable {
        ...
        public String moveVice() {
            ...
            System.out.println(org_name);
            System.out.println("..." + orglist.getName());
            String content = sessionUser.getName()+"撤销了" + orglist.getName() + "在" + org_name +  "的副机构管理员";
            boolean res = orglistdao.moveViceAdmin(orglist.getId_user(), org_name, content);
            dataMap.put("res",res);
            return SUCCESS;
        }
